# Ship Workbench Anchor

## 第一章：定位总览（最简）

- `guide.ship.workbench` -> 断言 `[data-testid='ship-build-view'][data-view-mode='workbench']`
- `guide.ship.workbench.slot-type.engine` -> 点击 `[data-testid='slot-type-engine']`，断言按钮含 `slot-type-btn-active`
- `guide.ship.workbench.slot-type.thruster` -> 点击 `[data-testid='slot-type-thruster']`，断言按钮含 `slot-type-btn-active`
- `guide.ship.workbench.slot-type.shield` -> 点击 `[data-testid='slot-type-shield']`，断言按钮含 `slot-type-btn-active`
- `guide.ship.workbench.slot-type.weapon` -> 点击 `[data-testid='slot-type-weapon']`，断言按钮含 `slot-type-btn-active`
- `guide.ship.workbench.slot-type.turret` -> 点击 `[data-testid='slot-type-turret']`，断言按钮含 `slot-type-btn-active`

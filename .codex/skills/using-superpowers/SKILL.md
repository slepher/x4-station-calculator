...
<EXTREMELY-IMPORTANT>
If you think there is even a 1% chance a skill might apply to what you are doing, you ABSOLUTELY MUST load the skill instructions.

IF A SKILL APPLIES TO YOUR TASK, YOU DO NOT HAVE A CHOICE. YOU MUST APPLY IT.
...
**In Codex (this repository):** Load the relevant `SKILL.md` directly from disk.
- If `.codex/skills/<skill-name>/SKILL.md` exists, use it as the only source for that skill.
- Otherwise, use the skill path listed by the project instructions.
- Do not block on a platform-specific `Skill` API.

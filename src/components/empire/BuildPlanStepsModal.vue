          ...
          >
            ...
            <div v-if="expandedSteps.has(row.step.order)" class="px-3 py-2 bg-slate-900/30 border-t border-slate-700">
              ...
              <template v-else>
                ...
                >
                  <span>{{ t('sector.build_plan.materials') }}</span>
                  <span class="text-right">×{{ t('sector.build_plan.count') }}</span>
                  <span class="text-right">{{ t('sector.build_plan.stock') }}</span>
                  <span class="text-right">{{ t('sector.build_plan.self_prod') }}/h</span>
                  <span class="text-right">+{{ t('sector.build_plan.produced') }}</span>
                  <span class="text-right">{{ t('sector.build_plan.buy') }}</span>
                  <span class="text-right">{{ t('sector.build_plan.unit_price') }}</span>
                </div>
                <div

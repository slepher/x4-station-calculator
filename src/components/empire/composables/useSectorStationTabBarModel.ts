...
export interface UseSectorStationTabBarModelDeps {
...
export interface UseSectorStationTabBarModelReturn {
  props: ComputedRef<StationTabBarProps>
  expandedSectorId: Ref<string | null>
  emits: StationTabBarEmits
}

export function useSectorStationTabBarModel(deps: UseSectorStationTabBarModelDeps): UseSectorStationTabBarModelReturn {
  const {
    sectors,

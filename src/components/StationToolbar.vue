  ...
  <div class="toolbar-panel">
    <div class="flex items-center gap-1.5 ml-4">
      <button class="btn-tool btn-cyan" @click="handleNew">
        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>
        <span>{{ t('ui.new') }}</span>
      </button>
      ...
      <button class="btn-tool btn-blue" @click="handleSaveAs">
        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M7 21h10"/><path d="M7 3h10"/><path d="M10 8h4"/><path d="M10 16h4"/><rect width="20" height="20" x="2" y="2" rx="2"/></svg>
        <span>{{ t('ui.save_as') }}</span>
      </button>
      <button class="btn-tool btn-cyan" @click="handleLoad">
        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
        <span>{{ t('ui.load') }}</span>
      </button>
...
.btn-cyan { @apply bg-cyan-500 hover:bg-cyan-400 text-slate-900; }

.btn-blue { @apply bg-blue-600 hover:bg-blue-500; }
.btn-gray { @apply bg-slate-500 hover:bg-slate-400; }
/* Amber 按钮用于 Import，高对比度跳脱背景 */
.btn-amber { @apply bg-amber-600 hover:bg-amber-500; }

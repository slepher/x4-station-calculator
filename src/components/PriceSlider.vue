...
<template>
  <div class="slider-container">
    <div class="slider-wrapper">
      ...
      <input 
        type="range" :value="modelValue" @input="updateValue"
...
.slider-wrapper {
  @apply space-y-1.5;
  max-width: 240px; /* 固定一个合适的宽度值，确保在不同页面视觉一致 */
}

.slider-header { @apply flex justify-between text-[10px] text-slate-500 font-bold tracking-tighter; }
.slider-label { @apply opacity-80; }

...
.header-subtitle {
  @apply font-mono text-[10px] text-slate-500 uppercase;
}

.simulation-controls {
  @apply p-4 bg-slate-900/50 border-b border-slate-700 flex;
}

.main-toggle {
  @apply flex justify-between px-3 py-2 bg-slate-800/50 hover:bg-slate-700 cursor-pointer border-b border-slate-700/50 transition-colors select-none;
}

.toggle-label {
  @apply flex items-center gap-2 text-sky-400 font-bold text-[11px] uppercase;
}

/* 通用箭头规范：修复斜体偏移 */
.arrow {
  @apply text-[10px] text-slate-500 opacity-70 transform transition-all duration-200 mr-1;
}

.arrow-open {
  @apply rotate-90 text-white opacity-100;
}
...
.module-row {
  @apply flex justify-between px-3 py-2 bg-slate-800 hover:bg-slate-700 cursor-pointer border-b border-slate-700/50 select-none;
}
...
.cost-value {
  @apply font-mono text-slate-400 text-xs;
}

.material-details {
  @apply bg-slate-950/50 shadow-inner;
}

.mat-row {
  @apply flex justify-between items-center pl-8 pr-3 py-1 text-[11px] border-b border-slate-800/30 last:border-0 hover:bg-slate-800/50;
}
...
.total-row-toggle {
  @apply flex justify-between items-center px-3 py-3 font-black border-t border-slate-600 cursor-pointer transition-colors select-none hover:bg-slate-700 relative;
}

.total-label {
  @apply flex items-center gap-2 text-emerald-400 uppercase leading-none;
}
...
.summary-details {
  @apply bg-slate-950/50 shadow-inner overflow-hidden;
}

.summary-item {
  @apply flex justify-between items-center pl-8 pr-3 py-1.5 text-[11px] border-b border-slate-800/30 last:border-0 hover:bg-slate-800/50 transition-colors;
}
...
.empty-tip {
  @apply pl-8 py-2 text-xs text-slate-600 italic;
}
</style>
    ...
    <div class="w-full max-w-2xl bg-slate-800 border border-slate-600 rounded-lg shadow-2xl flex flex-col animate-fade-in">
      ...
      <div class="flex justify-between items-center px-6 py-4 border-b border-slate-700 bg-slate-900/30">
        <h3 class="text-xl font-bold text-white tracking-wide flex items-center gap-2">
          ...
          {{ t('ui.import_plans') || 'Import Plans' }}
        </h3>
        <button 
          @click="handleClose"
      ...
      <div class="p-6 space-y-4">
        <p class="text-slate-300 text-sm leading-relaxed">
          Paste the <code class="text-amber-400 font-mono">constructionplans.xml</code> content or an <code class="text-amber-400 font-mono">x4-game.com</code> share link below. The plans will be added to your current layout.
        </p>
        ...
        <textarea 
          ...
          placeholder="<plan>...</plan> OR https://x4-game.com/#/station-calculator?l=..."
        ></textarea>
        ...
        <div v-if="hasError" class="text-red-400 text-sm flex items-center gap-2">
          ...
          Import failed. Please check the format.
        </div>
      </div>

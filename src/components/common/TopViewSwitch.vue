...
const defaultTabs = computed<TopSwitchItem[]>(() => [
  { key: 'blueprint-production', label: t('view.blueprint_production'), activeClass: 'bg-blue-600 text-white shadow-lg' },
  { key: 'live-production', label: t('view.live_production'), activeClass: 'bg-cyan-600 text-white shadow-lg' },

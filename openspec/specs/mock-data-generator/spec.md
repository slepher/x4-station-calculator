...
This specification describes the mock data generator functionality for the X4 Station Calculator. The mock data generator creates realistic test data based on the same business logic as the UI components.

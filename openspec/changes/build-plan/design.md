...
#### BootstrapMode.None（不自举）
| 序号 | 大标题 | 小标题 | 说明 |
|-----|-------|-------|-----|
| 1 | 输入建材 | 输入建材模块 | 仅当当前产能不足时输出 |
| 2 | 目标产线 | 目标产线系列模块 | 必选 |

#### BootstrapMode.Joint（联合自举）
| 序号 | 大标题 | 小标题 | 说明 |
|-----|-------|-------|-----|
| 1 | D 联合自举 | D(A+B) 联合自举模块 | greedyFill 自举 |
| 2 | 目标产线 | 目标产线系列模块 | 必选 |

#### BootstrapMode.CoupledIterative（耦合迭代自举）
| 序号 | 大标题 | 小标题 | 说明 |
|-----|-------|-------|-----|
| 1 | A 建材自举 | A 建材自举模块 | greedyFill + 迭代 |
| 2 | B 特种产线 | B 特种产线模块 | 一次性计算 |
| 3 | 目标产线 | 目标产线系列模块 | 必选 |

#### BootstrapMode.NestedJoint（嵌套联合自举）
| 序号 | 大标题 | 小标题 | 说明 |
|-----|-------|-------|-----|
| 1 | D 联合自举 | D(A+B) 联合自举模块 | greedyFill 自举 |
| 2 | A 子集 | A 基础建材模块 | 从 D 提取 |
| 3 | 目标产线 | 目标产线系列模块 | 必选 |

#### BootstrapMode.IsolatedSpecialized（孤立特种自举）
| 序号 | 大标题 | 小标题 | 说明 |
|-----|-------|-------|-----|
| 1 | B 特种孤岛 | B 特种孤岛模块 | 一次性计算 |

...
- [x] 8.1 紧凑版现有节点显示模块名称（使用 `node.moduleId` 查找）
- [x] 8.2 紧凑版预览节点显示模块名称（根据 `wareId` + 血统查找）
- [x] 8.3 紧凑版新产线 Header 显示模块名称
- [x] 8.4 拖拽幽灵元素显示模块名称（自定义 `setDragImage`）
- [x] 8.5 T0 资源和隔离节点回退显示产品名称

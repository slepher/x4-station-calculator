...
- [✗] 2.1 状态: 仅载入大太刀
  ...
  - [✓] 2.1.6 切换到引擎槽位类型(E)，断言引擎槽位有装备名称 #期望: ['engine_ter_m_allround_01_mk1']
  - [✗] 2.1.7 切换到推进器槽位类型(R)，断言推进器槽位有装备名称 #期望: ['thruster_gen_m_allround_01_mk1']
  - [ ] 2.1.8 切换到护盾槽位类型(S)，断言护盾槽位有装备名称 #期望: ['shield_ter_m_standard_02_mk2']
  - [ ] 2.1.9 切换到武器槽位类型(W)，断言武器槽位有装备名称 #期望: ['weapon_ter_m_beam_01_mk2']
  - [ ] 2.1.10 切换到炮塔槽位类型(T)，断言炮塔槽位有装备名称 #期望: ['turret_ter_m_beam_01_mk1']
...
- [✗] 2.2 状态: 仅载入大阪
  ...
  - [ ] 2.2.7 切换到推进器槽位类型(R)，断言推进器槽位有装备名称 #期望: ['thruster_gen_l_allround_01_mk1']

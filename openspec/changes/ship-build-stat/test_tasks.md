...
- [✗] 2.1 状态: 仅载入大太刀
  - [✓] 2.1.1 清除localStorage
  - [✓] 2.1.2 加载db.json到localStorage
  - [✓] 2.1.3 打开Ship Build页面
  - [✓] 2.1.4 点击"Load"按钮打开模态框
  - [✓] 2.1.5 在模态框中选择 "Odachi" 蓝图
  - [✓] 2.1.6 点击确认
  - [✗] 2.1.7 断言飞船信息区显示大太刀名称 #期望: ['大太刀']
  - [ ] 2.1.8 断言引擎槽位有装备 engine_ter_m_allround_01_mk1 数量1 #期望: [1]
  - [ ] 2.1.9 断言推进器槽位有装备 thruster_gen_m_allround_01_mk1 数量1 #期望: [1]
  - [ ] 2.1.10 断言护盾槽位有装备 shield_ter_m_standard_02_mk2 数量2 #期望: [2]
  - [ ] 2.1.11 断言武器槽位有装备 weapon_ter_m_beam_01_mk2 数量4 #期望: [4]
  - [ ] 2.1.12 断言炮塔槽位有装备 turret_ter_m_beam_01_mk1 数量2 #期望: [2]

- [✗] 2.2 状态: 仅载入大阪
  - [✓] 2.2.1 清除localStorage
  - [✓] 2.2.2 加载db.json到localStorage
  - [✓] 2.2.3 打开Ship Build页面
  - [✓] 2.2.4 点击"Load"按钮打开模态框
  - [✓] 2.2.5 在模态框中选择 "Osaka 2" 蓝图
  - [✓] 2.2.6 点击确认
  - [✗] 2.2.7 断言飞船信息区显示大阪名称 #期望: ['大阪']
  - [ ] 2.2.8 断言引擎槽位有装备 engine_ter_l_allround_01_mk1 数量6 #期望: [6]
  - [ ] 2.2.9 断言护盾专用槽位有装备 shield_ter_l_standard_01_mk2 数量2 #期望: [2]
  - [ ] 2.2.10 断言护盾专用槽位有装备 shield_ter_l_standard_01_mk3 数量2 #期望: [2]
  - [ ] 2.2.11 断言武器槽位有装备 weapon_ter_l_destroyer_01_mk1 数量6 #期望: [6]
  - [ ] 2.2.12 断言炮塔槽位有装备 turret_ter_l_beam_01_mk1 数量6 #期望: [6]
  - [ ] 2.2.13 断言炮塔槽位有装备 turret_tel_l_plasma_01_mk1 数量3 #期望: [3]
...
- [✗] 3.1 Case: 简略字段对齐
  ...
  - [ ] 3.1.4 断言包含：船体、护盾、雷达范围、武器爆发输出值、炮塔平均输出值、集装仓储、M级泊位数量、M级飞船容量、S级泊位数量、S级飞船容量、速度、助推速度、巡航速度、船员、单位、导弹、可投放设备、干扰弹 #期望: [18]

...
- [✓] 3.12 Case: S级过滤器交互
  - [✓] 3.12.1 通过data属性判断飞船选择状态 #新增强: data-ship-selected
  - [✓] 3.12.2 情况A:已选飞船则点击"Change Ship"切换
  - [✓] 3.12.3 断言S级过滤器按钮可见 #期望: [toBeVisible]
  - [✓] 3.12.4 点击S级按钮
  - [✓] 3.12.5 断言S级按钮选中状态 #期望: [filter-chip-active]
  - [✓] 3.12.6 断言种族过滤器显示 #期望: [toBeVisible]

- [✓] 3.13 Case: XL级过滤器交互
  - [✓] 3.13.1 通过data属性判断飞船选择状态 #新增强: data-ship-selected
  - [✓] 3.13.2 情况A:已选飞船则点击"Change Ship"切换
  - [✓] 3.13.3 断言XL级过滤器按钮可见 #期望: [toBeVisible]
  - [✓] 3.13.4 点击XL级按钮
  - [✓] 3.13.5 断言XL级按钮选中状态 #期望: [filter-chip-active]
  - [✓] 3.13.6 断言种族过滤器显示 #期望: [toBeVisible]
...
- [ ] 4.1 BUG-001: Summary模式缺少导弹/可投放设备/干扰弹字段
  - [ ] 4.1.1 状态: 仅载入大太刀
  - [ ] 4.1.2 点击"简略"档位按钮
  - [ ] 4.1.3 断言字段集合包含18项 #期望: [18]
  - [ ] 4.1.4 修复前: 断言字段集合包含15项 #期望: [15]
  - [ ] 4.1.4 修复后: 断言字段集合包含18项 #期望: [18]
  - [ ] 4.1.5 修复前: 断言missile字段不可见 #期望: [toBeHidden]
  - [ ] 4.1.5 修复后: 断言missile字段可见 #期望: [toBeVisible]
  - [ ] 4.1.6 修复前: 断言deployable字段不可见 #期望: [toBeHidden]
  - [ ] 4.1.6 修复后: 断言deployable字段可见 #期望: [toBeVisible]
  - [ ] 4.1.7 修复前: 断言countermeasure字段不可见 #期望: [toBeHidden]
  - [ ] 4.1.7 修复后: 断言countermeasure字段可见 #期望: [toBeVisible]

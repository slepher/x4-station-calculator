...
- [✓] 4.3 BUG-003: 无装备槽位打开Picker后候选槽无法点击
  - [✓] 4.3.1 进入船只建造视图，选择大太刀
  - [✓] 4.3.2 选择一个没有装备的槽位（如新武器槽位）
  - [✓] 4.3.3 点击该槽位打开Picker
  - [✓] 4.3.4 点击候选列表中的候选槽
...
- [✓] 4.4 BUG-004: 空候选槽数值为0时样式显示错误
  ...
  - [✓] 4.4.3 选择空候选槽（取消引擎）
  - [✓] 4.4.4 修复前：断言boostDuration数值显示为绿色 #期望: [green]
  - [✓] 4.4.4 修复后：断言boostDuration数值显示为灰色 #期望: [gray]

- [✓] 4.5 BUG-005: 空槽位选择新引擎后属性值为0时样式显示错误
  - [✓] 4.5.1 进入船只建造视图，使用 Change Ship 选择大太刀
  - [✓] 4.5.2 切换到引擎标签
  - [✓] 4.5.3 点击引擎槽位打开Picker
  - [✓] 4.5.4 选择一个非空引擎（候选）
  - [✓] 4.5.5 修复前：断言boostDuration数值为0时显示绿色 #期望: [green]
  - [✓] 4.5.5 修复后：断言boostDuration数值为0时显示灰色 #期望: [gray]

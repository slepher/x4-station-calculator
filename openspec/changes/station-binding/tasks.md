...
- [ ] 14. Stage 2 星区组重构
- [ ] 14.1 重构列表结构：上方帝国星区，下方存档星区
- [ ] 14.2 Empire sector 添加绑定按钮及弹出菜单
- [ ] 14.3 菜单组1：筛选后未绑定的存档星区候选（超过10个提示搜索筛选）
- [ ] 14.4 菜单组2：地图可见星区候选（面积>50%，超过10个提示调整缩放）
- [ ] 14.5 绑定后展开 empire sector：跳数、范围星区、备选星区、取消|确定
- [ ] 14.6 范围星区药丸：点击 x 移到备选
- [ ] 14.7 备选星区药丸：点击 + 移到范围
- [ ] 14.8 确定后折叠显示范围星区药丸
- [ ] 14.9 Save sector 显示归属星区药丸标签
- [ ] 14.10 已绑定时绑定按钮转为取消绑定按钮